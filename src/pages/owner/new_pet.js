                            ...
                            <div className="card_">
                                <div className="card_body_">
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-md-6">
                                            <div>
                                                ...
                                                <select name="select" className="input_ w-100">
                                                    <option value="value2">CANINO</option>
                                                    <option value="value1">FELINO</option>
                                                    <option value="value1">OTROS</option>
                                                </select>                        
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="row" style={{marginTop: 10}}>
                                        <div className="col-md-6">
                                            <div>
                                                <button className="btn_ btn_secondary_ w-100" onClick={categoryRegistration}>Registrar mascota</button>
                                            </div>
                                        </div>
                                        <div className="col-md-6">
                                            <div>
                                                <Link href='/owner/pets/'>
                                                    <button className="btn_ btn_danger_ w-100">Ver mascotas</button>
                                                </Link>
                                            </div>
                                        </div>
                                    </div>
