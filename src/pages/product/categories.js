...
const Categorie = () => {
    ...
    async function getCategories(page=1){
        try {
            ...
            const res = await fetch(`/api/product/categories?from=${from}`);
        ...
        <>
            <Container>
                <div className="container">
                    <div className='row'>
                        <div>
                            <h6 style={{marginTop: 15, fontWeight: 600}}>MANTENIMIENTO DE CATEGORIAS</h6>
                        </div>
                    </div>
                    <div className="row">
                                    ...
                                    <div className="row">
                                        <div>
                                            <div className="col-md-2">
                                                <Link href='/product/new_category'>
                                                    <button className="btn_ btn_secondary_ w-100">Agregar categoría</button>
                                                </Link>
                                            </div>
