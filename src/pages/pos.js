        ...
        <>
            <Container>
                <div className="container">
                    <div className='row'>
                        <div>
                            <h6 style={{marginTop: 15, fontWeight: 600}}>POS</h6>
                        </div>
                    </div>
                    <div className="row">
                                ...
                                <div className="card_body_">
                                    <div className="row" style={{marginTop:10}}>
                                        <div className="col-md-3">
                                            <div>
                                                <label className="label_">Buscar propietario:</label>
                                        ...
                                        <div className="col-md-6">
                                            <div>
                                                <Link href='/owner/pets/'>
                                                    <button className="btn_ btn_danger_ w-100">Totalizar factura</button>
                                                </Link>
                                            </div>
                                        </div>
                                    </div>
